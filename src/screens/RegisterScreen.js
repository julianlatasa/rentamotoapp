...
export const RegisterScreen = ({ onSwitchToLogin }) => {
  ...
  const handleRegister = async () => {
    ...
    if (password.length < 6) {
      Alert.alert('Error de Validación', 'La contraseña debe tener al menos 6 caracteres');
      return;
    }
    ...
    if (documento.length < 5) {
      Alert.alert('Error de Validación', 'El documento debe tener al menos 5 caracteres');
      return;
    }
  ...
  return (
    <View style={styles.centerContainer}>
      ...
      <Text style={{ marginTop: 10, marginBottom: 5, fontWeight: 'bold' }}>Nombre</Text>
      <TextInput
        style={styles.input}
        placeholder="Ej: Juan"
        value={nombre}
      ...
      <Text style={{ marginTop: 10, marginBottom: 5, fontWeight: 'bold' }}>Apellido</Text>
      <TextInput
        style={styles.input}
      ...
      <Text style={{ marginTop: 10, marginBottom: 5, fontWeight: 'bold' }}>Documento</Text>
      <TextInput
        style={styles.input}
      ...
      <Text style={{ marginTop: 10, marginBottom: 5, fontWeight: 'bold' }}>Email</Text>
      <TextInput
        style={styles.input}
      ...
      <Text style={{ marginTop: 10, marginBottom: 5, fontWeight: 'bold' }}>Contraseña</Text>
      <TextInput
        style={styles.input}
